...
date: 2026-02-11
image: "/images/blog/ai-agents-production.jpg"
categories:
  - ai-engineering
  - langchain
  - llmops
...
└──────────┬──────────────────────────┘
    ...
    ▼             ▼              ▼              ▼
┌────────┐  ┌─────────┐  ┌──────────┐  ┌──────────┐
│NLP→SQL │  │  RAG    │  │Knowledge │  │ Anomaly  │
│ Agent  │  │  Q&A    │  │  Graph   │  │Detector  │
└────────┘  └─────────┘  └──────────┘  └──────────┘
```
...
```
Query → Embedding → FAISS Retrieval → Reranking → LLM Generation → Citation
```
