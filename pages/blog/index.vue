  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
    <div class="max-w-6xl mx-auto">
      ...
      <div v-motion-fade-visible-once class="text-center mb-16">
        ...
        >
          My thoughts on AI engineering, system design, and building at
          scale.
        </p>
      </div>

      <!-- Category Filter — only shown when posts exist -->
      <div
      ...
      <div v-else-if="error" class="text-center py-20">
        <Icon
          ...
          class="h-16 w-16 text-red-500 mb-4 mx-auto"
          aria-hidden="true"
        />
        <h2
      ...
      <!-- ────────────────────────────────────────────────────────── -->
      <!-- EMPTY STATE — shown when no posts exist (or category empty) -->
      <!-- ────────────────────────────────────────────────────────── -->
      <div
        v-else
        v-motion
      ...
      >
        ...
        >
          ...
          >
            {{
              selectedCategory
                ? `No posts in "${selectedCategory.replace('-', ' ')}"`
          ...
          >
            <template v-if="selectedCategory">
              No posts found in this category yet. Try viewing all posts
              or check back later.
            </template>
            <template v-else>
              I'm writing about AI agent architectures, production
              LLMOps, and lessons from 6 years of enterprise
...
const {
  ...
  error,
  refresh,
} = await useAsyncData<BlogPost[]>('blog-posts', () =>
