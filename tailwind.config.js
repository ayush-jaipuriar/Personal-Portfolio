...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Light-mode accent: white/slate + vermilion.
        'apple-blue': {
          50: '#fff1ee',
          100: '#ffe1dc',
          200: '#ffc9bf',
        ...
        // Dark-mode accent: graphite + signal green.
        signal: {
          50: '#edfff5',
          100: '#d5ffe9',
          200: '#afffd5',
      ...
      typography: (theme) => ({
        ...
        invert: {
          css: {
            ...
            '--tw-prose-links': theme('colors.signal.400'),
            ...
            a: {
              color: theme('colors.signal.400'),
              '&:hover': {
                color: theme('colors.signal.300'),
              },
            },
          },
        },
